...
axios.get('https://us-central1-missao-newton.cloudfunctions.net/astroMatch/matheus-natal-shaw/person', {
}).then((response) =>{
...
.catch((err)=>{
  ...
  const choosePerson =(choice) =>{
    const url = `https://us-central1-missao-newton.cloudfunctions.net/astroMatch/matheus-natal-shaw/choose-person`
